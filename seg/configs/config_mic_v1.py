...
model = dict(
    ...
    train_cfg=dict(
        work_dir=
        'work_dirs/local-basic/240924_1248_gtaHR2csHR_mic_hrda_s2_a653e',
        log_config=dict(
            interval=50,
            img_interval=1000,
            hooks=[dict(type='TextLoggerHook', by_epoch=False)])),
...
name = '240924_1248_gtaHR2csHR_mic_hrda_s2_a653e'
exp = 'basic'
...
work_dir = 'work_dirs/local-basic/240924_1248_gtaHR2csHR_mic_hrda_s2_a653e'
